package com.example.tester; // Change this to match your actual app package name
    ...
    private void setupSignUpLink() {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(@NonNull View widget) {
                ...
                // If your register activity is called RegisterActivity, uncomment these lines:
